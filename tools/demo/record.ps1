...
; filament used [g] = 18.40, 0.00, 6.20, 0.00
; total filament used [g] = 24.60
; total layers count = 120
; estimated printing time (normal mode) = 2h 14m 8s

; CONFIG_BLOCK_START
; filament_type = PLA;PLA;PETG;PLA
; filament_colour = #E64B3B;#2D9E59;#1F8CE0;#FFFFFF
