...
> App: `Snapmaker.Studio_0.4.0-beta.6_x64-setup.exe`
...
- https://github.com/DeadlyVirusIn/snapmaker-studio/releases/tag/v0.4.0-beta.6
...
```powershell
Get-FileHash -Algorithm SHA256 ".\Snapmaker.Studio_0.4.0-beta.6_x64-setup.exe"
```
