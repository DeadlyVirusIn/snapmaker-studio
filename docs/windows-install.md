...
> App: `Snapmaker.Studio_0.4.0-beta.5_x64-setup.exe`
...
- https://github.com/DeadlyVirusIn/snapmaker-studio/releases/tag/v0.4.0-beta.5
...
```powershell
Get-FileHash -Algorithm SHA256 ".\Snapmaker.Studio_0.4.0-beta.5_x64-setup.exe"
```
