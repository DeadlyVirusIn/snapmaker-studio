...
Everything below ran against the **published v0.8.0 installer** — installed,
...
| Backend | 1346 passed, 3 skipped | `pytest` |
| Desktop | 321 passed | `npm run test` |
...
| Download | [Releases](https://github.com/DeadlyVirusIn/snapmaker-studio/releases/tag/v0.8.0) · hash in [../RELEASE_METADATA.md](../RELEASE_METADATA.md) |
