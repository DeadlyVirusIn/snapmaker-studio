...
Everything below ran against the **published v0.7.2 installer** — installed,
...
| Backend | 1185 passed, 3 skipped | `pytest` |
...
| Download | [Releases](https://github.com/DeadlyVirusIn/snapmaker-studio/releases/tag/v0.7.2) · hash in [../RELEASE_METADATA.md](../RELEASE_METADATA.md) |
