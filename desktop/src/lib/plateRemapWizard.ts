...
export const COPY = {
  ...
  success: "Remapped copy saved — only the selected plate's color changed; painted details, other filaments, and all other plates were preserved.",
  ...
  exportCta: "Create remapped copy — original stays unchanged",
  confirmTitle: "Review before creating copy",
  proofTitle: "Remapped copy saved",
